            ...
            <div class="content text-center">
                ...
                <div class="row justify-content-center mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <a href="{{ url('/order') }}" class="btn btn-photos rounded-0">SHOW</a>
                    </div>
                    ...
                    <div class="col-md-6">
                    <a href="{{ route('wishlist.show') }}" class="btn btn-photos rounded-0">WISHLIST</a>

                    </div>
                    <div class="col-md-6">
                    <a href="{{ route('order.show') }}" class="btn btn-photos rounded-0">ORDERS</a>
